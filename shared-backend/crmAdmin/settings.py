...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication',  # Legacy token support (fallback)
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,  # Disabled for now (requires additional setup)
...
JITSI_USE_PUBLIC_SERVER = os.getenv('JITSI_USE_PUBLIC_SERVER', 'false')  # Force use public meet.jit.si server
